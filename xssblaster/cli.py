...
def parse_args() -> argparse.Namespace:
    ...
    io_group.add_argument(
        '-o', '--output',
        help='Output file to write payloads (default: stdout)'
    )
    io_group.add_argument(
        '-i', '--input',
    ...
    wrap_group.add_argument(
        '-p', '--prefix',
        default='',
        help='Prefix to prepend to each payload'
    )
    wrap_group.add_argument(
        '-s', '--suffix',
        default='',
        help='Suffix to append to each payload'
    )
    wrap_group.add_argument(
        '--ep', '--encode-prefix',
        dest='encode_prefix',
    ...
    enc_group.add_argument(
        '-b', '--base64',
        action='store_true',
        help='Generate Base64 encoded payloads'
    )
    enc_group.add_argument(
        '-U', '--unicode',
        action='store_true',
        help='Generate Unicode escaped payloads'
    )
    enc_group.add_argument(
        '-H', '--hex',
        action='store_true',
        help='Generate hex encoded payloads'
    )
    enc_group.add_argument(
        '-O', '--octal',
        action='store_true',
        help='Generate octal encoded payloads'
    )
    enc_group.add_argument(
        '-D', '--decimal',
        action='store_true',
        help='Generate decimal encoded payloads'
    )
    ...
    enc_group.add_argument(
        '-C', '--css',
        action='store_true',
        help='Generate CSS unicode encoded payloads'
    )
    ...
    enc_group.add_argument(
        '-R', '--reverse',
        action='store_true',
        help='Generate reversed payloads'
    )
    ...
    enc_group.add_argument(
        '-a', '--atob',
        action='store_true',
        help='Generate atob() encoded payloads'
    )
    enc_group.add_argument(
        '-r', '--rot13',
        action='store_true',
        help='Generate ROT13 encoded payloads'
    )
    enc_group.add_argument(
        '-q', '--quotedprint',
        action='store_true',
    ...
    enc_group.add_argument(
        '-uu', '--uuencode',
        action='store_true',
        help='Generate UUencoded payloads'
    )
    enc_group.add_argument(
        '-P', '--punycode',
        action='store_true',
    ...
    enc_group.add_argument(
        '-B', '--binary',
        action='store_true',
        help='Generate binary encoded payloads'
    )
...
def cli() -> int:
    ...
    try:
        ...
        try:
            ...
            print(f"\n[+] Total input base payloads: {base_count}")
            print(f"[+] Total output payloads: {total_count}")
        ...
        if hasattr(e, 'errno') and e.errno == 2:  # File not found
            print(f"[-] Make sure the input file exists: {args.input}", file=sys.stderr)
        return 1
